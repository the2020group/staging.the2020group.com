...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<table cellspacing="0">
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<?php if(strpos($code, 'renew_') !== false) : //print_r($coupon); ?>
				<tr class="cart-discount ">
					<th>Renewal discount</th>
					<td><span class="amount">£<?php echo number_format($coupon->coupon_amount, 2); ?></span></td>
				</tr>
			<?php else : ?>
	...
	<?php if ( WC()->cart->get_cart_tax() ) : ?>
		<p><small><?php
			...
			$estimated_text = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()
				...
				printf( __( 'Please note: The VAT shown will be updated during checkout based on your country of residence. This will be done on the following page.', 'woocommerce' ) )
		?></small></p>
	<?php endif; ?>
