...
<div style="padding: 20px; text-align: center;">
  <p style="padding:0; margin:0;"><strong><?php _e( 'If you are based inside the European Union (excluding the United Kingdom) you are required to account for VAT under the reverse charge procedure.', 'wpo_wcpdf' ); ?></strong></p>
</div>
