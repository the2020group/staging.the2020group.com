...
<div id="reviews">
	...
	<?php else : ?>
		...
		<p class="woocommerce-verification-required"><?php _e( 'Only logged in members who have access to, or have purchased this product may leave a review.', 'woocommerce' ); ?></p>
