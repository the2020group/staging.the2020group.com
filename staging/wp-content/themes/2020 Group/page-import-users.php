...
$file = fopen(__DIR__.'/library/imports/member_contacts_live-updated-2.csv','r');
    ...
    while(($cont = fgetcsv($file,9000,',')) !== FALSE) {
        ...
        if ($line > 0 && $cont[0] !='' && isset($cont[0])&& $cont[6]!='') {
            ...
            $user['sm']            = utf8_encode($cont[12]);
            $user['im']            = utf8_encode($cont[13]);
            ...
            if ($user['sm']=='' || $user['im']=='') {
               ...
               $continue = false;
               $errors[] = 'Contact: '.$user['email'].' Problem: missing price. line too long??';

                error_log('missing price');
                ...
                if ( !$user_id && email_exists($user['email']) == false ) {
                    ...
                    if ($user_id == 0) {
                        ...
                        if ($user['im']!='' || $user['sm']!='') {
                            ...
                            if ($user['sm']!='' ) {
                                // setting up subscriptions for ma
                                ...
                                if ($type == 'Partner') {
                                    ...
                                    if ($p_id > 0) {
                                        ...
                                        if (in_array('020113 Mem - January',$user['tags']['02 Behavioural Tags'])) {
                                            $start_date ='2014-01-01 00:00:01';
                                            $expiry_date = '2015-01-31 23:59:59';
                                            $next_payment = $expiry_date;
                                        }
                                        elseif (in_array('020114 Mem - February',$user['tags']['02 Behavioural Tags'])) {
                                            $start_date ='2014-02-01 00:00:01';
                                            $expiry_date = '2015-02-28 23:59:59';
                                            $next_payment = $expiry_date;
                                        }
                                        elseif (in_array('020115 Mem - March',$user['tags']['02 Behavioural Tags'])) {
                                            $start_date ='2014-03-01 00:00:01';
                                            $expiry_date = '2015-03-31 23:59:59';
                                            $next_payment = $expiry_date;
                                        }
                                        elseif (in_array('020116 Mem - April',$user['tags']['02 Behavioural Tags'])) {
                                            $start_date ='2014-04-01 00:00:01';
                                            $expiry_date = '2015-04-30 23:59:59';
                                            $next_payment = $expiry_date;
                                        }
                                        elseif (in_array('020117 Mem - May',$user['tags']['02 Behavioural Tags'])) {
                                            $start_date ='2014-05-01 00:00:01';
                                            $expiry_date = '2015-05-31 23:59:59';
                                            $next_payment = $expiry_date;
                                        }
                                        elseif (in_array('020118 Mem - June',$user['tags']['02 Behavioural Tags'])) {
                                            $start_date ='2014-06-01 00:00:01';
                                            $expiry_date = '2015-06-30 23:59:59';
                                            $next_payment = $expiry_date;
                                        }
                                        elseif (in_array('020119 Mem - July',$user['tags']['02 Behavioural Tags'])) {
                                            $start_date ='2014-07-01 00:00:01';
                                            $expiry_date = '2015-07-31 23:59:59';
                                            $next_payment = $expiry_date;
                                        }
                                        elseif (in_array('020120 Mem - August',$user['tags']['02 Behavioural Tags'])) {
                                            $start_date ='2014-08-01 00:00:01';
                                            $expiry_date = '2015-08-31 23:59:59';
                                            $next_payment = $expiry_date;
                                        }
                            ...
                            if ($user['im']!='' ) {
                                ...
                                // setting up subscriptions for ma
                                $p_id = 313;
                                $item = $order->add_product( wc_get_product( $p_id ), 1 ); //(get_product with id and next is for quantity)
                                $values['data'] = array();
                                $values['product_id'] = $p_id;
                                $values['variation_id'] = $v_id;
                                ...
                                if (in_array('020204 Int - January',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-01-01 00:00:01';
                                    $expiry_date = '2015-01-31 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020205 Int - February',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-02-01 00:00:01';
                                    $expiry_date = '2015-02-28 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020206 Int - March',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-03-01 00:00:01';
                                    $expiry_date = '2015-03-31 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020207 Int - April',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-04-01 00:00:01';
                                    $expiry_date = '2015-04-30 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020208 Int - May',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-05-01 00:00:01';
                                    $expiry_date = '2015-05-31 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020209 Int - June',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-06-01 00:00:01';
                                    $expiry_date = '2015-06-30 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020210 Int - July',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-07-01 00:00:01';
                                    $expiry_date = '2015-07-31 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020211 Int - August',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-08-01 00:00:01';
                                    $expiry_date = '2015-08-31 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020212 Int - September',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-09-01 00:00:01';
                                    $expiry_date = '2015-09-30 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020213 Int - October',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-10-01 00:00:01';
                                    $expiry_date = '2015-10-31 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020214 Int - November',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-11-01 00:00:01';
                                    $expiry_date = '2015-11-30 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                elseif (in_array('020215 Int - December',$user['tags']['02 Behavioural Tags'])) {
                                    $start_date ='2014-12-01 00:00:01';
                                    $expiry_date = '2015-12-31 23:59:59';
                                    $next_payment = $expiry_date;
                                }
                                ...
                                error_log('im order created: '.$order->id);

                            }
                            else {
                                    error_log('no im order created');
                                }
