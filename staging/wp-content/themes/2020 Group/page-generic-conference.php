...
<div class="row">
  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> role="article">
			...
			<section class="entry-content conference-page conference-generic" itemprop="articleBody">
									        ...
									        $height = $image['sizes'][ $size ];
												...
												<div class="small-6 medium-3 columns end">
													...
													<div id="exhibitor-content-<?php echo $counter; ?>" class="exhibitor-popup" style="display: none;">
														...
														<img src="<?php echo $image[0]; ?>" alt="<?php echo get_the_title(get_field('exhibitor_logo')) ?>" />
				...
				?>					<?php if( have_rows('gallery_items') ): ?>
					...
					<?php while( have_rows('gallery_items') ): the_row();
						...
						<li class="slide">
							<?php $image = wp_get_attachment_image_src(get_sub_field('gallery_item'), 'conf-imagesm'); ?>
	...
	<div class="small-12 large-4 columns">
		<div class="conference-sidebar">
			...
			<?php if(get_field('guest_speaker_image')): ?>
				...
				<?php $image = wp_get_attachment_image_src(get_field('guest_speaker_image'), 'sidepanel-image'); ?>
				<div class="guest">
