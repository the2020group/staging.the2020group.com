jQuery(document).ready(function($) {
    ...
    jQuery( '#wcac_settings .subsubsub a.tab' ).click( function ( e ) {
        ...
        if ( jQuery( this ).hasClass( 'all' ) ) {
            jQuery( '#wcac_settings h3, #wcac_settings form p, #wcac_settings table.form-table, p.submit' ).show();
        ...
        jQuery( '#wcac_settings h3, #wcac_settings form > p:not(".submit"), #wcac_settings table' ).hide();
