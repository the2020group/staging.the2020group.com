...
function iw_to_country( $code = ''){
    ...
    if( $code == 'CG' ) $country = 'Democratic Republic of Congo';
    ...
    if( $code == 'BL' ) $country = 'St. Barthelemy';
    if( $code == 'SH' ) $country = 'St. Helena, Ascension and Tristan Da Cunha';
    if( $code == 'KN' ) $country = 'St. Kitts and Nevis';
    if( $code == 'LC' ) $country = 'St. Lucia';
    if( $code == 'MF' ) $country = 'St. Martin';
    if( $code == 'PM' ) $country = 'St. Pierre and Miquelon';
    if( $code == 'VC' ) $country = 'St. Vincent and the Grenadines';
    ...
    if( $code == 'UM' ) $country = 'US Minor Outlying Islands';
...
function iw_to_country_code( $country = ''){
    ...
    if($country == 'Bolivia') $code = 'BO';
    if($country == 'Bosnia and Herzegovina') $code = 'BA';
    if($country == 'Botswana') $code = 'BW';
    if($country == 'Bouvet Island (Bouvetoya)') $code = 'BV';
    if($country == 'Brazil') $code = 'BR';
    if($country == 'British Indian Ocean Territory (Chagos Archipelago)') $code = 'IO';
    ...
    if($country == 'Central African Republic') $code = 'CF';
    if($country == 'Chad') $code = 'TD';
    if($country == 'Chile') $code = 'CL';
    if($country == 'China') $code = 'CN';
    if($country == 'Christmas Island') $code = 'CX';
    if($country == 'Cocos (Keeling) Islands') $code = 'CC';
    if($country == 'Colombia') $code = 'CO';
    if($country == 'Comoros') $code = 'KM';
    if($country == 'Congo') $code = 'CD';
    if($country == 'Democratic Republic of Congo') $code = 'CG';
    if($country == 'Cook Islands') $code = 'CK';
    ...
    if($country == 'Faroe Islands') $code = 'FO';
    if($country == 'Falkland Islands') $code = 'FK';
    ...
    if($country == 'French Southern Territories') $code = 'TF';
    ...
    if($country == 'Holy See (Vatican City State)') $code = 'VA';
    ...
    if($country == 'Korea') $code = 'KP';
    if($country == 'Korea') $code = 'KR';
    if($country == 'Kuwait') $code = 'KW';
    if($country == 'Kyrgyzstan') $code = 'KG';
    if($country == 'Lao') $code = 'LA';
    ...
    if($country == 'Marshall Islands') $code = 'MH';
    ...
    if($country == 'Micronesia') $code = 'FM';
    if($country == 'Moldova') $code = 'MD';
    ...
    if($country == 'Reunion') $code = 'RE';
    if($country == 'Romania') $code = 'RO';
    if($country == 'Russian Federation') $code = 'RU';
    if($country == 'Rwanda') $code = 'RW';
    if($country == 'St. Barthelemy') $code = 'BL';
    if($country == 'St. Helena, Ascension and Tristan Da Cunha') $code = 'SH';
    if($country == 'St. Kitts and Nevis') $code = 'KN';
    if($country == 'St. Lucia') $code = 'LC';
    if($country == 'St. Martin') $code = 'MF';
    if($country == 'St. Pierre and Miquelon') $code = 'PM';
    if($country == 'St. Vincent and the Grenadines') $code = 'VC';
    ...
    if($country == 'Switzerland, Swiss Confederation') $code = 'CH';
    if($country == 'Syrian Arab Republic') $code = 'SY';
    if($country == 'Taiwan') $code = 'TW';
    ...
    if($country == 'US Minor Outlying Islands') $code = 'UM';
