...
class WC_Bundled_Item {
	...
	function bundled_item_available_variation( $variation_data, $bundled_product, $bundled_variation ) {
		...
		$quantity     = $this->get_quantity();
		$availability = $woocommerce_bundles->helpers->get_bundled_product_availability( $bundled_variation, $quantity );
	...
	function get_quantity() {
		return apply_filters( 'woocommerce_bundled_item_quantity', $this->quantity, $this );
	}
