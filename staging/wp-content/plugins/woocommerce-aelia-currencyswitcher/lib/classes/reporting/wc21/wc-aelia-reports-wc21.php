...
class Reports extends \Aelia\CurrencySwitcher\Reports {
	...
	// @var string The directory where the report override classes can be found.
	protected $report_overrides_dir = 'WC21';
	...
	protected function report_override_class($report_name) {
		...
		$report_override_class = '\\Aelia\\CurrencySwitcher\\' . $this->report_overrides_dir . '\\WC_CS_Report_' . $report_name;
